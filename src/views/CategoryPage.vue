      ...
      <div v-if="showModal"
        ...
        <div
          ...
          <div class="flex justify-end gap-2">
            ...
            <button @click="saveContent" class="px-4 py-2 bg-[#B48D3E] text-white rounded hover:opacity-90">
              Save
            </button>
          </div>
        </div>
      ...
      <div v-if="showDeleteModal"
        ...
        <div class="bg-white p-6 rounded-lg w-full max-w-md">
          ...
          <div class="flex justify-end gap-2">
            ...
            <button @click="confirmDelete()" class="px-4 py-2 bg-red-600 text-white rounded hover:opacity-90">
              Delete
            </button>
          </div>
        </div>
